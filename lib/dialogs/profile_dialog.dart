...
class ContentTabView extends StatefulWidget {
  ...
  @override
  ContentTabViewState createState() => ContentTabViewState();
}
...
class _ClientProfileDialogState extends State<ClientProfileDialog> {
  ...
  void initState() {
    ...
    nameTC = TextEditingController(text: widget.user?.name ?? '');
    idTC = TextEditingController(text: widget.user?.id ?? '');
    keyTC = TextEditingController(text: widget.user?.key ?? '');
  }
  ...
  build(BuildContext context) {
    ...
    getTextWidget(TextEditingController cont, bool b, FontWeight fw) => b
        ? Expanded(
            child: TextField(
              controller: cont,
              style: TextStyle(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      getTextWidget(nameTC, nameBool, FontWeight.bold),
                      SizedBox(
                          height: 25,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      getTextWidget(idTC, idBool, FontWeight.w600),
                      SizedBox(
                          height: 25,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      getTextWidget(keyTC, keyBool, FontWeight.w600),
                      SizedBox(
                          height: 25,
